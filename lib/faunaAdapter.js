...
// create collections: users, accounts, sessions, verification_requests
...
const INDEX_USERS_ACCOUNT_ID_PROVIDER_ID = 'index_accounts_provider_id_provider_account_id';
const INDEX_VERIFICATION_REQUESTS_TOKEN = 'index_verification_requests_token';
const INDEX_SESSIONS_ID = 'index_sessions_id';
const INDEX_SESSIONS_SESSION_TOKEN = 'index_sessions_session_token';

const serverClient = new faunadb.Client({ secret: process.env.NEXT_PUBLIC_FAUNADB_SECRET });
